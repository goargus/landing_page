<template>
    <section class="flex flex-col items-center text-center w-full max-w-[1167px] text-neutral-600 mx-auto">
        <article class="grid grid-cols-1 md:grid-cols-2 gap-12 mt-3 w-full">
            <IconCard
